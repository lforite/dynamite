...
private[dynamite] case class DateStamp(value: String) extends AnyVal
private[dynamite] case class DateTimeStamp(value: String) extends AnyVal
...
private[dynamite] case class AwsService(value: String) extends AnyVal
private[dynamite] case class AwsAuthorization(credential: String, signature: String)
private[dynamite] case class AwsSigningKey(value: Array[Byte]) extends AnyVal
private[dynamite] case class AwsStringToSign(value: String, scope: AwsScope)
private[dynamite] case class AwsScope(value: String) extends AnyVal
private[dynamite] case class AwsCanonicalRequest(value: String, signedHeaders: AwsSignedHeaders)
private[dynamite] case class AwsSignature(value: String) extends AnyVal
...
private[dynamite] case class Uri(value: String) extends AnyVal

private[dynamite] case class AwsHttpRequest(host: AwsHost, requestBody: RequestBody, signedHeaders: List[HttpHeader])
private[dynamite] case class RequestBody(value: String) extends AnyVal

private[dynamite] case class AwsHttpResponse(statusCode: StatusCode, responseBody: ResponseBody)
private[dynamite] case class StatusCode(value: Int) extends AnyVal
private[dynamite] case class ResponseBody(value: String) extends AnyVal
...
private[dynamite] case class AwsSigningCredentials(value: String) extends AnyVal

private[dynamite] case class AwsSignedHeaders(value: String) extends AnyVal
